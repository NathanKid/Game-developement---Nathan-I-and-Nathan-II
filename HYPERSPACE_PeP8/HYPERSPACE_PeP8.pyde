...
#  x-coordinate, y-coordinate of enemy bullets
...
def setup():
    global bullet_sprite, ebullet_sprite, player_sprite, enemy1, heart
    size(800, 700)
    frameRate(60)
    smooth()
...
def draw():
    global timer, page, button_x, button_y, button_width, button_height
